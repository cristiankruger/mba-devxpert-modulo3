...
public class Validacoes
{
    ...
    public static void ValidarSeDiferente(string valor, string pattern, string mensagem)
    {
    ...
    public static void ValidarSeDiferente(string valor, string pattern, string mensagem, RegexOptions options)
    {
    ...
    {
        if (valor is not null && (valor.Trim().Length < minimo || valor.Trim().Length > maximo))
            throw new DomainException(mensagem);
    }
    ...
    public static void ValidarSeMenorQue(string valor, char splitChar, string mensagem)
    {
        var ano = Convert.ToInt16(valor.Split(splitChar)[1]);
        var mes = Convert.ToInt16(valor.Split(splitChar)[0]);
